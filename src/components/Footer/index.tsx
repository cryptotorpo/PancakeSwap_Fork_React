    ...
    return (
        <Body>
            ...
            <div style={{ display: 'flex', paddingLeft: '30px' }}>
                ...
                <span style={{ fontSize: '40px', fontFamily: 'Fredoka', alignSelf: 'center' }}>TedClark</span>
            </div>
            <BlurCircle />
            <Grid>
                ...
                <div style={{ display: 'flex', gap: '15px', flexDirection: 'column' }}>
                    <Span>Products</Span>
                    <SpanItem>TedClark Smartchain</SpanItem>
                    <SpanItem>TedClark Exchanges</SpanItem>
                    <SpanItem>TedClark Block Explorer</SpanItem>
                    <SpanItem>TedClark Wallet</SpanItem>
                    <SpanItem>Alterverse</SpanItem>
                    <SpanItem>NFT Marketplace</SpanItem>
                    <SpanItem>TedClark Coin</SpanItem>
